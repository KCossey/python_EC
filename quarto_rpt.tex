...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{phrase }\OperatorTok{=} \StringTok{"Hello, World!"}
\NormalTok{edit }\OperatorTok{=}\NormalTok{ phrase.split(}\StringTok{","}\NormalTok{)}
\BuiltInTok{print}\NormalTok{(edit)}
\end{Highlighting}
\end{Shaded}
